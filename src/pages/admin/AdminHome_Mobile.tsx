      ...
      <section className="px-4 mb-4">
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="grid w-full grid-cols-4 bg-navy-800/90 rounded-xl">
            ...
            <TabsTrigger value="calendar" className="text-xs py-2 data-[state=active]:bg-indigo-500/20">Calendar</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="calendar" className="mt-2">
            <div className="bg-navy-950 rounded-xl p-2 border border-navy-900">
              <AdminCalendarView adminVenues={adminVenues} />
            </div>
          </TabsContent>
        </Tabs>
      </section>
