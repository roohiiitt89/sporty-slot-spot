...
const PeakHours_Mobile: React.FC = () => {
  ...
  return (
    <div className="space-y-6 p-4 max-w-md mx-auto">
      <div className="flex flex-col gap-4">
        <div>
          <h1 className="text-2xl font-bold">Peak Booking Hours</h1>
          <p className="text-muted-foreground">Most popular hours for bookings</p>
        </div>
...
export default PeakHours_Mobile; 