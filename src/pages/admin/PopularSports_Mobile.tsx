...
const PopularSports_Mobile: React.FC = () => {
  ...
  return (
    <div className="space-y-6 p-4 max-w-md mx-auto">
      <div className="flex flex-col gap-4">
        <div>
          <h1 className="text-2xl font-bold">Popular Sports</h1>
          <p className="text-muted-foreground">Distribution and popularity of sports by bookings</p>
        </div>
...
export default PopularSports_Mobile; 
