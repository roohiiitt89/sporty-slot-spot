...
<section className="hero-section">
  ...
  />
    ...
    <div className="flex flex-col md:flex-row justify-center gap-4 animate-fade-in" style={{
      ...
      <section className="search-bar-section py-8 bg-navy-dark">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-center items-center gap-4">
            <input type="text" placeholder="Search by sport" className="w-full md:w-1/3 px-4 py-2 rounded-md focus:outline-none" />
            <input type="text" placeholder="Location" className="w-full md:w-1/3 px-4 py-2 rounded-md focus:outline-none" />
            <input type="date" className="w-full md:w-1/3 px-4 py-2 rounded-md focus:outline-none" />
            <button className="bg-indigo text-white px-6 py-2 rounded-md hover:bg-indigo-dark transition-colors">
              Search
            </button>
          </div>
        </div>
