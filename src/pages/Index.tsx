    ...
    <div className="min-h-screen bg-navy-dark text-card-foreground">
      ...
      >
        <video
          ...
          poster="https://lrtirloetmulgmdxnusl.supabase.co/storage/v1/object/public/venues//%20-3.jpg"
        >
          <source 
        ...
        <div className="hero-content container mx-auto px-4 h-full flex flex-col justify-center text-center relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4 animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <button 
              ...
              className="dynamic-button flex items-center justify-center px-8 py-3 bg-indigo-600 hover:bg-indigo-700 rounded-lg font-medium transition-colors"
            >
              Book A Slot Now
            ...
            <Link 
              to="/venues" 
              className="nike-button bg-white text-indigo border border-indigo px-8 py-3 rounded-lg font-medium hover:bg-gray-100 transition-colors"
            >
              Browse Venues
            </Link>
          </div>
          <EnterChallengeButton className="mt-8" />
        </div>
      </section>
                ...
                <CarouselContent className="-ml-2 md:-ml-4">
                  {venues.map((venue, index) => (
                    <CarouselItem key={venue.id} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/4">
                      <div 
                        className="venue-card group hover-3d bg-navy-light rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all"
                ...
                <CarouselContent className="-ml-2 md:-ml-4">
                  {sports.map((sport, index) => (
                    <CarouselItem key={sport.id} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/4">
                      <div 
                        className="sport-card group cursor-pointer overflow-hidden rounded-xl bg-navy-light shadow-lg hover:shadow-xl transition-all"
                        style={{ animationDelay: `${0.1 * (index + 1)}s` }}
